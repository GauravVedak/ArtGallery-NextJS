  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <Col lg={6}>
          <p>
            The main building, on the eastern edge of Central Park along the Museum Mile section of Fifth Avenue, is by
            area one of the world's largest art museums. For more details, visit the{" "}
            <a
